  ...
  return (
    <div className='flex flex-col justify-center items-center h-screen'>
        ...
        <form className='flex flex-col justify-center items-center' onSubmit={formSubmitHandler}>
           ...
           <label htmlFor="username">username</label> <input className='text-black p-2' type="text" value={formData.username} placeholder='Username' onChange={handleChangeFormData} name='username'/>
           ...
           <button type='submit' disabled={!shouldFormSubmit} className='text-black bg-white mt-2 p-2' >Signup</button>
        </form>
    </div>
  )
}
